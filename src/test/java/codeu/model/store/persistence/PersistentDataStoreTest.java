...
public class PersistentDataStoreTest {
  ...
  public void testSaveAndLoadConversations() throws PersistentDataStoreException {
    ...
    Instant creationOne = Instant.ofEpochMilli(1000);
    Conversation inputConversationOne = new Conversation(idOne, ownerOne, titleOne, creationOne, false, null);
    ...
    Instant creationTwo = Instant.ofEpochMilli(2000);
    Conversation inputConversationTwo = new Conversation(idTwo, ownerTwo, titleTwo, creationTwo, false, null);
