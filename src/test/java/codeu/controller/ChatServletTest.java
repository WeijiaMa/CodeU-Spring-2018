...
public class ChatServletTest {
  ...
  public void testDoGet() throws IOException, ServletException {
    ...
    Conversation fakeConversation =
        new Conversation(fakeConversationId, UUID.randomUUID(), "test_conversation", Instant.now(), false, null);
  ...
  public void testDoPost_StoresMessage() throws IOException, ServletException {
    ...
    Conversation fakeConversation =
        new Conversation(UUID.randomUUID(), UUID.randomUUID(), "test_conversation", Instant.now(), false, null);
    Mockito.when(mockConversationStore.getConversationWithTitle("test_conversation"))
        .thenReturn(fakeConversation);
